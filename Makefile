...
create-postgres-server:
	docker run -d --net automatedaftermath-net --name automatedaftermath-postgres13 -p 5433:5432 -e POSTGRES_USER=automatedaftermath -e POSTGRES_PASSWORD=mysecretpassword -v pg13-aa:/var/lib/postgresql/data postgres:13
